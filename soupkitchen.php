	...
	<body class="fullpage logged-out" cz-shortcut-listen="true">
		...
		<div id="result-iframe-wrap" role="main">
			<div class="table-title">
				<h3 style="float: left;">Soup Kitchen Listing</h3>
				<div class="header-chunk primary-actions secondary-nav">
					<div class="signup-and-login">
						<a id="login-button" class="button button-editor-solid login-button" href="soupkitchen_add.php">Add</a>
					</div>
				</div>
			</div>
			<table class="table-fill">
				<thead>
					<tr>
						...
						<th class="text-left">Locations</th>
